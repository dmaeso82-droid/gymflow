...
class TrainerMeasurementsPage extends StatefulWidget {
  ...
  const TrainerMeasurementsPage({super.key, required this.gymId});

  @override
  State<TrainerMeasurementsPage> createState() => _TrainerMeasurementsPageState();
}

class _TrainerMeasurementsPageState extends State<TrainerMeasurementsPage> {
              ...
              children: [
                ...
                if (selected != null) ...[
                  BodyMeasurementsPanel(
                    ...
                    filterValue: (selected.data()['email'] ?? '').toString().toLowerCase(),
